...
var multicastdns = require('mdns-server')
...
function Server (opts) {
  ...
  this.mdns.on('error', this._onMdnsError.bind(this))
}
...
Server.prototype._onMdnsError = function (error) {
    if(error.errno !== "EADDRNOTAVAIL") throw error;
    else if(!error.address.startsWith("169.254")) throw error;
}
